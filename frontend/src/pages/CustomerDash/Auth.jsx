      ...
      <div className="auth-page">
        ...
        >
          ...
          {type === 'sign up' && (
            <>
              <TextField
                fullWidth
                label="First Name"
                onChange={(e) => setCustomer((prev) => ({ ...prev, fName: e.target.value }))}
              ...
              <TextField
                fullWidth
                label="Last Name"
                onChange={(e) => setCustomer((prev) => ({ ...prev, lName: e.target.value }))}
          ...
          <TextField
            ...
            required
          />
          <Button variant="contained" color="success" sx={{ px: 5, py: 1 }} type="submit">
            {type === 'sign in' ? 'Login' : 'Register'}
          </Button>
          {type === 'sign in' ? (
            <p style={{ fontSize: '14px' }} onClick={() => setType('sign up')}>
              Do you not have an Account?{' '}
              <span style={{ fontSize: '14px', color: '#2382ed', cursor: 'pointer' }}>
                Register
              </span>
            </p>
          ) : (
            <p style={{ fontSize: '14px' }} onClick={() => setType('sign in')}>
