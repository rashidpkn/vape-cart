...
export const PRODUCT_CATEGORY_GROUP_OPTIONS = [
  ...
  },
  {
    group: 'Puffs',
    classify: [
      1000, 1200, 1500, 2000, 2500, 300, 3000, 350, 3500, 400, 4000, 450, 4500, 500, 5000, 5500,
      575, 600, 800, 10000, 12000, 245, 2600, 320, 5001, 5002, 5003, 5004, 5005, 5006, 5800, 6000,
      700, 7000, 8000, 8500,
    ].map((puff) => `${puff} Puffs`),
  },
];
